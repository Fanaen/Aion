 ...
 * @author Fanaen
 */
public class SubjectListEditPanel extends javax.swing.JPanel {
    ...
    public void setItem(SubjectList sequence) {
        this.item = sequence;
     ...
     */
    public SubjectListEditPanel(SubjectList sequence, DefaultMutableTreeNode node, PanelListener listener) {
        initComponents();
