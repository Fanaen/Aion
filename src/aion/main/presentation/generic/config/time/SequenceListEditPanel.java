 ...
 * @author Fanaen
 */
public class SequenceListEditPanel extends javax.swing.JPanel {
    ...
    public SequenceList getItem() {
        return item;
    }

    public void setItem(SequenceList sequence) {
        this.item = sequence;
     ...
     */
    public SequenceListEditPanel(SequenceList sequence, DefaultMutableTreeNode node, PanelListener listener) {
        initComponents();
